...
REFERENCE_CHANNELS_BY_MOTOR = {
    0: {"glove_key": "thumb_2", "glove_open": 330.75, "glove_closed": 327.52},
    ...
    6: {"glove_key": "index_1", "glove_open": 246.87, "glove_closed": 249.97},
    7: {"glove_key": "ring_1", "glove_open": 119.54, "glove_closed": 129.38},
    8: {"glove_key": "pinky_1", "glove_open": 287.12, "glove_closed": 288.22},
}
...
def apply_motion_controls(data: dict[str, Any], args: argparse.Namespace) -> dict[str, Any]:
    ...
    if args.reference_keypoints:
        metadata["reference_keypoints"] = "2026-06-17 user-guided EG glove feature probe"
    if args.disable_thumb_rotation:
        metadata["thumb_rotation"] = "disabled; motor 9 held fixed"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        action="store_false",
        help="Keep existing glove_key/open/closed values instead of applying the user-guided reference map.",
    )
    ...
    parser.set_defaults(disable_thumb_rotation=True, reference_keypoints=True)
    return parser
